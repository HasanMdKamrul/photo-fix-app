...
const Banner = () => {
  return (
    ...
    >
      <div class="flex items-center justify-center flex-col w-full h-full bg-gray-900 bg-opacity-50">
        ...
        <button class="w-auto px-4 py-2 mt-4 text-sm font-medium text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
          See Reviews
        </button>
      </div>
    </div>
